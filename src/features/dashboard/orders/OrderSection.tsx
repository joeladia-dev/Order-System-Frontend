    ...
    <Card>
      ...
      <CardContent>
        <p className="mb-3 rounded-md border border-border/70 bg-background/75 px-3 py-2 text-xs text-muted-foreground">
          ...
          session). Admin Product Access is optional and only needed for product
          catalog updates.
        </p>
        <form className="space-y-3" onSubmit={controller.createOrder}>
          <div className="space-y-1.5">
            ...
            <Input
              ...
              readOnly
              placeholder="Sign in to load your customer ID"
              required
            />
            <p className="text-[11px] text-muted-foreground">
              View only. This ID is automatically set from your signed-in
              account.
            </p>
          </div>
          <div className="space-y-1.5">
          ...
          <div className="space-y-1.5">
            ...
            >
              ...
              {controller.products.map((product) => {
                ...
                return (
                  ...
                  >
                    {product.name} ({product.id}) - ${product.price.toFixed(2)}{" "}
                    · stock {product.stock}
            ...
            {selectedProduct && (
              <p className="text-[11px] text-muted-foreground">
                Selected: {selectedProduct.name} · stock {selectedProduct.stock}{" "}
                    ...
                    >
                      ...
                      <div className="grid grid-cols-[1fr_auto] gap-2">
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            controller.removeOrderItem(item.productId)
                          }
                        >
                          Remove
                        </Button>
